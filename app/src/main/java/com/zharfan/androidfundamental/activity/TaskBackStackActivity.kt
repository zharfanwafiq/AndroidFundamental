...
import com.zharfan.androidfundamental.databinding.ActivityTaskBackStackBinding
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.apply {
                ...
                vibrationPattern = longArrayOf(
                    VIBRATE_1000, VIBRATE_1000, VIBRATE_1000,
                    VIBRATE_1000
                )
            }
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.btnOpenDetail -> {
                ...
                intent.apply {
                    putExtra(
                        DetailTaskBackStackActivity.EXTRA_TITLE,
                        getString(R.string.detail_title)
                    )
                    putExtra(
                        DetailTaskBackStackActivity.EXTRA_MESSAGE,
