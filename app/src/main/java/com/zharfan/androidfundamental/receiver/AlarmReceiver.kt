package com.zharfan.androidfundamental.receiver
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val title =
            if (type.equals(TYPE_ONE_TIME, ignoreCase = false)) TYPE_ONE_TIME else TYPE_REPEATING
        val notificationId =
    ...
    private fun showAlarmNotification(
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            ...
            .setVibrate(longArrayOf(TIME_1000, TIME_1000, TIME_1000, TIME_1000))
            .setSound(alarmSound)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.apply {
                ...
                vibrationPattern = longArrayOf(TIME_1000, TIME_1000, TIME_1000, TIME_1000)
            }
